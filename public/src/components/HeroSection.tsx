export default function HeroSection() {
  return (
    <section className="relative min-h-[70vh] sm:min-h-[80vh] flex items-center justify-center overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto py-16 sm:py-20">
        {/* Logo */}
        <div className="animate-fade-in-up mb-8">
          <img
            src="https://i.imgur.com/bynthbo.png"
            alt="VAROUSS Logo"
            className="mx-auto w-52 sm:w-64 md:w-72 h-auto drop-shadow-[0_0_30px_rgba(213,41,41,0.3)]"
          />
        </div>

        {/* Divider */}
        <div className="animate-fade-in-up delay-200 opacity-0 flex items-center justify-center gap-4 mb-6">
        ...
        {/* Slogan */}
        <p className="animate-fade-in-up delay-300 opacity-0 font-montserrat text-lg sm:text-xl md:text-2xl text-varouss-white/90 font-medium tracking-wide mb-3">
          Diseñamos tu marca. Vestimos tu idea.
        </p>

        {/* Description */}
        <p className="animate-fade-in-up delay-400 opacity-0 font-opensans text-sm sm:text-base text-varouss-gray/70 max-w-xl mx-auto leading-relaxed">
        ...
        {/* Scroll indicator */}
        <div className="animate-fade-in delay-600 opacity-0 mt-12 animate-float">
